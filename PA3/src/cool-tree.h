...
public:
   ...
   virtual void check_type(Class_ cur_class) = 0;
   virtual Symbol get_name() = 0;
...
public:
   ...
   virtual Symbol check_type(Class_ cur_class) = 0;
...
public:
   ...
   void dump(ostream& stream, int n);
   void check_type(Class_ cur_class);
...
public:
   ...
   Case copy_Case();
   void dump(ostream& stream, int n);
   Symbol check_type(Class_ cur_class);
